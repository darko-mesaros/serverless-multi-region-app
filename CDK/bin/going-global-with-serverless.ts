...
new GoingGlobalWithServerlessStack(app, 'euWest1GoingGlobalWithServerlessStack',{
    env: envIreland,
...
new GoingGlobalWithServerlessStack(app, 'usEast1GoingGlobalWithServerlessStack',{
    env: envVirginia,
    certArn: "arn:aws:acm:us-east-1:824852318651:certificate/b66cfe74-6930-438b-b43a-aa1bb12ab9c2",
    customDomain: "globalddb.rup12.xyz"
});

new GoingGlobalWithServerlessStack(app, 'usWest1GoingGlobalWithServerlessStack',{
    env: envCalifornia,
    certArn: "arn:aws:acm:us-west-1:824852318651:certificate/70d7903c-f536-4db6-96b3-157851614367",
    customDomain: "globalddb.rup12.xyz"
});

new GoingGlobalWithServerlessStack(app, 'apNortheast1GoingGlobalWithServerlessStack',{
    env: envTokyo,
